...
app_1.app.post('/api/v1/user/drive/:folder/folders', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var folder, user, drivePath, path, name, id, parentMeta;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                parentMeta = fs.existsSync(path + "/meta.json") ? JSON.parse(fs.readFileSync(path + "/meta.json").toString()) : {};

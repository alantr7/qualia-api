...
exports.sessionManager = exports.app = void 0;
...
exports.app = express();
exports.sessionManager = new session_manager_1.SessionManager();
...
exports.app.use(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (exports.sessionManager.hasSession(req)) {
                console.log('There is a session!');
                next();
                return [2 /*return*/];
            }
            console.log('No session found.');
            session = exports.sessionManager.createSession();
